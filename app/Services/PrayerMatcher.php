...
class PrayerMatcher
{
    ...
    public function __construct()
    {
        $this->stopwords = [
            ...
            'em', 'no', 'na', 'nos', 'nas', 'para', 'pra', 'pro', 'com',
            'que', 'se', 'por', 'ao', 'aos', 'num', 'numa', 'dum', 'duma',
            'ele', 'ela', 'eles', 'elas', 'me', 'te', 'se', 'nos', 'vos',
            'lhe', 'lhes', 'eu', 'tu', 'ele', 'nós', 'vós', 'eles',
            'um', 'uma', 'uns', 'umas', 'este', 'esta', 'estes', 'estas',
            'esse', 'essa', 'esses', 'essas', 'aquele', 'aquela', 'aqueles', 'aquelas',
            'isto', 'isso', 'aquilo', 'já', 'mais', 'menos', 'muito', 'pouco',
            'todo', 'toda', 'todos', 'todas', 'tudo', 'também', 'ainda', 'quando',
            'onde', 'como', 'qual', 'quais', 'quem', 'cada', 'sem', 'sobre',
            'depois', 'antes', 'entre', 'contra', 'tal', 'tais', 'outro', 'outra',
            'mesmo', 'mesma', 'meu', 'minha', 'teu', 'tua', 'seu', 'sua',
            'nosso', 'nossa', 'vosso', 'vossa', 'dela', 'dele', 'delas', 'deles',
            'até', 'após', 'mas', 'porém', 'contudo', 'todavia', 'então', 'logo',
            'porque', 'pois', 'caso', 'embora', 'assim', 'bem', 'mal', 'sim',
            'não', 'era', 'são', 'está', 'estão', 'ser', 'ter', 'tem',
            'tinha', 'tido', 'sido', 'vai', 'vão', 'foi', 'fui', 'ir',
            'há', 'hão', 'haja', 'ter', 'teve', 'tiver', 'tiveram',
            'daí', 'nisso', 'nesse', 'nessa', 'nisto', 'nesse', 'nessa',
            'lá', 'cá', 'ali', 'aqui', 'sim', 'talvez', 'ora',
        ];
    }
    ...
    public function tokenize(string $text): array
    {
        ...
        return array_values(array_filter($words, fn(string $w) => !in_array($w, $this->stopwords, true)));
    }
    ...
    public function score(array $tags, array $signalWords): float
    {
        ...
        $tagWords = preg_split('/[\s\p{P}]+/u', mb_strtolower($tagText, 'UTF-8'), -1, PREG_SPLIT_NO_EMPTY);
