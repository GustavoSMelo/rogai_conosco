...
- **Instant prayer library as static PHP array**: `resources/data/prays.php` returns an associative array keyed by religion, each containing an array of prayer texts. This avoids a database table for now.
