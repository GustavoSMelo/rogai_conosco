...
**Purpose:** Enforce consistent use of Tailwind `@apply` directives across all CSS files, replacing raw CSS values with Tailwind utility classes wherever possible.
