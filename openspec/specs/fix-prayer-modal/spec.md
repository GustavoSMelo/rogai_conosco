...
**Purpose:** Improve the prayer request modal UX by fixing interaction issues (select dropdown closing the modal, contact fields visibility) and refactoring into a two-step flow with smooth transitions.
