# Welcome Delivery Options

**Purpose:** Explain the three recorded prayer delivery sub-options (Apenas oração, Apenas palavra, Oração + palavra) on the welcome page so users understand the difference before submitting a prayer request.
