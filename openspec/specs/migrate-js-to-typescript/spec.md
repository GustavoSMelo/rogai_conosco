...
**Purpose:** Migrate the frontend JavaScript codebase in `resources/js/` from plain JavaScript to TypeScript, with appropriate tooling configuration, type annotations, and build pipeline updates.
