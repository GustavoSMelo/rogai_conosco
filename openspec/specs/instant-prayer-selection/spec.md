# Instant Prayer Selection

**Purpose:** Select appropriate instant prayers based on user description, supporting matcher-based, random, and deterministic selection strategies.
